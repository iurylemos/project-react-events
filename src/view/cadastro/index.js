...
function Cadastro() {
    ...
    return (
        ...
        // Isso aqui abaixo se chama encapusamento
        //É usando quando quero instânciar um componente fora de algum HTML
        //E com isso o return retorna como se fosse um único elemento
        <>
        <NavBar></NavBar>
